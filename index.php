	...
	<div id="footer">
		...
		<div id="bg-footer">
			<div id="noidungfooter" >
				<div id="lg-footer" style="margin-left:200px">
					<h3><a href="index.php">logo</a></h3>
				</div><!-- End .lg-footer -->
				<div id="noidung" style="margin-left:200px">
					<ul>
						<li><span id="tencongty">Trang web bán hàng điện thoại Cyberphone</span></li> <br>
						
						<li>Địa chỉ: Hà Đông - Hà Nội </li>
						<li>Điện thoại: 0951079509 </li>
						<li>Email:  cthang429@gmail.com</li>
					</ul>
				</div><!-- End .noidung -->
				<div id="thanhngang" style="margin-left:70px">
					<img src="img/thanhngang-footer.png">
				</div><!-- End .thanhngang -->
				<div id="copyright" style="margin-left:130px" >
					<p>Nhóm thực hành số 7 | Lớp : Hệ quản trị CSDL | Gmail : cthang429@gmail.com<p>
				</div><!-- End .copyright -->
